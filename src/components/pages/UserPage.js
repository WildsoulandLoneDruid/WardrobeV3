...
function UserPage() {
  ...
  const [wardrobesInUse, setwardrobesInUse] = React.useState([]);
  const [newLocation, setNewLocation] = useState('');
  const [newArticleRFID, setnewArticleRFID] = useState('');
  ...
  function refreshAllData() {
    ...
    fetchData().then(({data:{email, fullName, wardrobe,_id}}) =>{
      ...
      setItems(wardrobesInUse.articleData);
    })
  }
                ...
                return  (
                  <>
                    ...
                    <Grid container direction="row" alignContent="flex-start" justify="space-between">
                      ...
                      <Button variant="contained" color="default" onClick={() => setModalIsOPen(true)}>
                        Add Article 
                      </Button>
                      ...
                      style={
                        ...
                        <h1>Wardrobe {index + 1}: {individualWardrobe.location}</h1>
                        <Box>Picture Upload Maybe</Box>
                        <TextField fullWidth id="standard-basic" label="RFID" value ={newArticleRFID} onInput={e => setnewArticleRFID(e.target.value)}/>
                        <TextField fullWidth id="standard-basic" label="Color" value ={newArticleColor} onInput={e => setnewArticleColor(e.target.value)}/>
                        <TextField fullWidth id="standard-basic" label="Type" value ={newArticleType} onInput={e => setnewArticleType(e.target.value)}/>
                      ...
                      <Button variant="contained" color="primary" onClick={async()=>{
                        setwardrobesInUse(individualWardrobe)
